...
from clickup_api import models
...
class ClickUpClient:
    ...
    def get_task(self, task_id: str, subtasks: bool = False) -> models.Task:
        ...
        if subtasks:
            supplied_values.append(f"include_subtasks=true")

        joined_url = f"?{'&'.join(supplied_values)}"

        model = "task/"

        fetched_task = self.__get_request(model, task_id, joined_url)
