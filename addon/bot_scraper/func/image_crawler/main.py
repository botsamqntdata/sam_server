...
def crawl_image(skip_already_exist = True, n_threads = 4, do_google = True, do_naver = False, 
                  full_resolution = False, face = False, no_gui = 'auto', limit = 0):
    print('Options - skip:{}, threads:{}, google:{}, naver:{}, full_resolution:{}, face:{}, no_gui:{}, limit:{}'
      .format(skip_already_exist, n_threads, do_google, do_naver, full_resolution, face, no_gui, limit))
    crawler = AutoCrawler(skip_already_exist, n_threads, do_google, do_naver, full_resolution, face, no_gui, limit)
    crawler.do_crawling()
